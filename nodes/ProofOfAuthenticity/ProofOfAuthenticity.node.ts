		...
		for (let i = 0; i < items.length; i++) {
			try {
				...
				// ============================================
					...
					const c2paDownloadUrl = this.getNodeParameter('c2paDownloadUrl', i) as string;
					const binaryPropertyName = this.getNodeParameter('c2paBinaryProperty', i, 'c2pa_file') as string;
